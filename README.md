...
- 31.10. Дерево отрезков
    - Постановка задачи:
        - Дан массив размера n и m запросов (1 < n, m < 10^5). Нужно отвечать на запросы двух видов:
            - 1. Найти сумму всех элементов на отрезке \[i, j\]
            - 2. Прибавить x ко всем элементам на отрезке \[i, j\]
    - Решение задачи для запросов первого типа при помощи префиксных сумм
    - Решение задачи при помощи дерева отрезков
    - Рекурсивное построение дерева отрезков сверху вниз
    - Дерево отрезков с групповыми изменениями
    - Реализация на массивах и в объектно-ориентированном стиле
